...
31 columns: Time, V1-V28 (28 PCA features), Amount, Class (target). Raw CSV.

## 2. Availability table (narrative)

Single CSV at `data/creditcard.csv`. Local; no external dependencies.
