...
- C2 pause currently has no built-in resume path; after confirming `pause_c2`, operator had to reset `consecutive_discards` manually to continue the campaign (apr22).
