...
-- Creates preventative care measures table with various CMS quality measures
...
-- Create preventative care table
...
FROM `{GCP_PROJECT}.{GCP_DB}.{PREFIX}_med_claims_flag_all`
WHERE year_flag = 1;

-- Create preventative care summary table
