-- Rx Claims Year 1 Query
-- Creates pharmacy claims tables for year 1 (12 months before index date)
...
DROP TABLE IF EXISTS `{GCP_PROJECT}.{GCP_DB}.{PREFIX}_rx_yr1`;
