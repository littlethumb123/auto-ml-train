...
user_constants = {
    ...
    "COSTCENTER": "13070",
    "TENANT": "hcm-cm-de",
    "service_account": "gchcb-hcm-cm-de-dec-onppq@anbc-test-hcm-cm-de.iam.gserviceaccount.com",
    "USE_COMPUTE_PROJECT": True,
    "OWNER": "sahil_gadge_aetna_com",
    "COMPUTE_PROJECT": "anbc-test-hcm-cm-de",
    ...
    "GCP_PROJECT": "anbc-hcb-test",
    "GCP_DB": "cm_medicaid_hcb_test",
    "PREFIX": "a974930_test_data_maternity",
    ...
    "BATCH_PREDICTION": {
    "model_resource_name": "projects/995383034658/locations/us-east4/models/4654905621492006912@1",
    "key_field": "asdb_member_key",
    "compute_dataset": "hcm_cm_de_dec_beam_test_hcm_cm_de",
    "expiration_days": 2,
...
PROJECT_ID = os.getenv("GOOGLE_CLOUD_PROJECT", "anbc-test-hcm-cm-de")
REGION = os.getenv("REGION", "us-east4")
PIPELINE_ROOT = os.getenv("PIPELINE_ROOT", "gs://hcm-cm-de-dec-data-hcb-test/vertex-test/")
ENCRYPTION_KEY = os.getenv("ENCRYPTION_KEY", "projects/cvs-key-vault-nonprod/locations/us-east4/keyRings/gkr-nonprod-us-east4/cryptoKeys/gk-anbc-test-hcm-cm-de-us-east4")
