...
user_constants = {
    ...
    "compute_dataset": "hcm_cm_de_dec_beam_dev_hcm_cm_de",
    "expiration_days": 2,
...
PIPELINE_ROOT = os.getenv("PIPELINE_ROOT", "gs://hcm-cm-de-dec-hcb-dev/vertex-test/")
...
test_query = """
    SELECT dispatch_outreach_status FROM anbc-hcb-dev.clin_analytics_dec_hcb_dev.DE_RAP_PCR_ACC_TRACKER_summarizedDISPATCHcalls LIMIT 1
    """
...
if __name__ == "__main__":
    ...
    pipeline_job.run(service_account="gchcb-hcm-cm-de-dec-ontpd@anbc-dev-hcm-cm-de.iam.gserviceaccount.com", sync=True)
